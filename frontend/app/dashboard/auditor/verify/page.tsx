      ...
      <div className="bg-white rounded-xl shadow p-6 mb-6">
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={handleCheck}
            disabled={loading}
            className="bg-chain-indigo text-white px-5 py-2 rounded-lg text-sm font-medium hover:bg-[#2F3FC0] disabled:opacity-50"
          >
        ...
        <div className="bg-white rounded-xl shadow p-6 space-y-4">
          <div
            className={`text-center py-4 rounded-lg font-semibold ${
              result.match ? "bg-[#E6F7F2] text-[#0F8F70]" : "bg-[#FDECEC] text-failure"
            }`}
          >
